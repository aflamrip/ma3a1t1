...
<div class="relative w-full group">
  ...
  <input 
     ...
     class="w-full bg-zinc-950/80 backdrop-blur border-2 border-zinc-800 focus:border-amber-500 focus:bg-zinc-900 focus:outline-none rounded-2xl py-4 pr-12 pl-6 text-xl text-white transition shadow-xl placeholder:text-zinc-600 font-medium"
     autocomplete="off"
  />
